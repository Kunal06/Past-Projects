 ...
 */
class AlarmControllerUI extends JFrame {
    ...
    /**
     * Adds AlarmTriggerLabel to the UI
     */
    private void addTriggerCountLabel() {
        AlarmTriggerLabel triggerLabel
                = new AlarmTriggerLabel();
        controlPanel.add(triggerLabel, BorderLayout.SOUTH);
        ac.addAlarmObserver(triggerLabel);
    }
