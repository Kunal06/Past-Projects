...
public class TagManagerTest {
    ...
    public void testRenameDNE() {
        aTagManager.createTag("A Tag");
        assertFalse(aTagManager.renameTag("No Tag", "A Tag"));
    }
    @Test
    public void testRenametocurrent() {
        aTagManager.createTag("A Tag");
        assertFalse(aTagManager.renameTag("No Tag", "A Tag"));
    }
    ...
    public void testrenametagnull() {
        aTagManager.createTag("CPSC");
        aTagManager.removeTag("CPSC");

        assertFalse(aTagManager.renameTag( "","new CPSC"));
          // remove this line when you implement this test
    }
    @Test
    public void testrenametal() {
        assertFalse(aTagManager.renameTag( "bob","new CPSC"));
        // remove this line when you implement this test
    }

    @Test
    public void testreremove(){
        aTagManager.createTag("Bobb");

        assertTrue(aTagManager.removeTag("Bobb"));
    }
    @Test
    public void testreremove1(){
        aTagManager.createTag("Bobb");

        assertFalse(aTagManager.removeTag(""));
    }
}
